    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="dangkyModalLabel">📌 Đăng ký học phần</h5>
            ...
            <form action="<?php echo BASE_URL; ?>hocphan/dangky" method="POST">
                <div class="modal-body">
                    ...
                    <p>Bạn có chắc muốn đăng ký học phần <strong><span id="tenhp_display"></span></strong>?</p>
                </div>
